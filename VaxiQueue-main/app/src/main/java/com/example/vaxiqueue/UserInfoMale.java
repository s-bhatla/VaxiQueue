...
public class UserInfoMale extends AppCompatActivity implements OnItemSelectedListener {
    float diab = 0;
    float htension = 0;
    float immunonum = 0;
    float resp = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_info_male);
    ...
    public void test(View view) {
        ...
        LottieAnimationView test = (LottieAnimationView) findViewById(R.id.textView10);
